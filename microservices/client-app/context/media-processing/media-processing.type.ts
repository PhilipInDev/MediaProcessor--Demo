...
type MediaProcessingContextType = {
	...
	setProcessingSuccess: Dispatch<SetStateAction<string | null>>;
	processingResult: ProcessingResult | null;
	setProcessingResult: Dispatch<SetStateAction<ProcessingResult | null>>;
}

export type { ProcessingResult, MediaProcessingContextType };
